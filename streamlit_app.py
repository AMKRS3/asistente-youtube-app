...
if 'credentials' not in st.session_state:
            ...
            if not videos_with_context:
                ...
                if not st.session_state.unanswered_comments:
                    ...
                    for i, chunk in enumerate(comment_chunks):
                        video_id_for_chunk = chunk[0]['video_id'] # Usamos el contexto del primer video del lote
                        ...
                        time.sleep(5) # Pausa de 5 segundos para no exceder límites
    ...
    if "unanswered_comments" in st.session_state and st.session_state.unanswered_comments:
        ...
        for i, item in enumerate(list(st.session_state.unanswered_comments)):
            ...
            comment_id = comment_thread['id'] # Usamos el ID del thread para responder
